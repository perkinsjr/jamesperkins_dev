...
const Index = () => {
    ...
    return (
        <>
            <Seo title="Home | James Perkins" description="Home page for James Perkins" image="https://res.cloudinary.com/dub20ptvt/image/upload/v1627762885/learn_to_code_home_bufala.png" />
